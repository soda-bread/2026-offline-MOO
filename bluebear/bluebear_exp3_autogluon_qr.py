...
from src.models import train_autogluon_qr_for_calibration
...
BLUEBEAR_MAX_PROBLEM_WORKERS = int(os.environ.get("BLUEBEAR_MAX_PROBLEM_WORKERS", "1"))
...
surrogate_config = experiment_config["surrogates"]["autogluon_qr"]
...
autogluon_quantile_levels = surrogate_config["quantile_levels"]
...
def train_model_for_calibration(problem, sample_size, train_seed=42, test_seed=1):
    return train_autogluon_qr_for_calibration(
        problem=problem,
        ...
        val_size=val_size,
        test_size=test_size,
        quantile_levels=autogluon_quantile_levels,
    )
